    ...
    public List<Product> GetAllProducts()
        {
            ...
            {
                connection.Open();
                var command = new SqlCommand("SELECT GoodCode, GoodName, GoodDescription, GoodPrice, ImgSrc, Category FROM Product", connection);
        ...
        public Product GetProductById(int id)
        {
            ...
            {
                connection.Open();
                var command = new SqlCommand("SELECT GoodCode, GoodName, GoodDescription, GoodPrice, ImgSrc, Category FROM Product WHERE GoodCode = @id", connection);
